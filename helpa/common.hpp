...
#if defined(__AVX2__)
#define HELPA_USE_X86
#endif

#if defined(__AVX512F__)
#define HELPA_USE_AVX512
#endif

#if defined(__AVX512VNNI__)
#define HELPA_USE_VNNI
#endif

#if defined(__aarch64__)
#define HELPA_USE_ARM
#endif

#if defined(__ARM_FEATURE_SVE)
#define HELPA_USE_SVE
#define HELPA_USE_SVE_BF16
#endif

#if defined(__F16C__)
#define HELPA_USE_F16C
#endif
