...
inline int32_t l2_u8_s8_ref(const uint8_t *x, const int8_t *y,
                            const int32_t d) {
  int32_t ans = 0;
  for (int32_t i = 0; i < d; ++i) {
...
inline int32_t l2_s8_s8_ref(const int8_t *x, const int8_t *y, const int32_t d) {
  int32_t ans = 0;
  for (int32_t i = 0; i < d; ++i) {
    auto d = int32_t(x[i]) - int32_t(y[i]);
    ans += d * d;
...
inline int32_t l2_u4_u4_ref(const uint8_t *x, const uint8_t *y,
                            const int32_t d) {
  int32_t ans = 0;
  for (int32_t i = 0; i < d; ++i) {
